...
export type EventPayloadMapping = {
  getStaticData: void;
  "generate-session-title": string | null;
  "get-recent-cwds": number | undefined;
  "select-directory": void;
  "get-api-config": void;
  "check-api-config": void;
  "save-api-config": any;
  statistics: any;
...
export type ClientEvent =
  ...
  | { type: "set-native-theme"; payload: "light" | "dark" | "system" };
