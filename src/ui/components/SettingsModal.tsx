        ...
        {loading ? (
          ...
          <div className="mt-5 grid gap-4">
            ...
            <label className="grid gap-1.5">
              ...
              <div className="grid grid-cols-3 gap-2 rounded-xl border border-ink-900/10 bg-surface-secondary p-1">
                {(['light', 'dark', 'system'] as const).map((t) => (
                  <button
                    key={t}
                    onClick={() => setTheme(t)}
                    className={`rounded-lg px-3 py-1.5 text-sm font-medium transition-all ${theme === t
